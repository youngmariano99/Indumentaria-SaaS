-- ==============================================================================
-- SCRIPT DE PRUEBA: BIG DATA FERRETERÍA (10.000 PRODUCTOS + DISTRIBUCIÓN REAL)
-- ==============================================================================
...
BEGIN
    ...
    VALUES (v_tenant_id, 'Gran Ferretería Depot', '30-44455566-1', 'ferre-demo', 'es-AR', NOW() - interval '60 days', v_rubro_id, '{}', '{}', '{"ModuloVentas": true, "ModuloStock": true, "ModuloCRM": true}');
    ...
    -- 5. GENERAR 50 CLIENTES CRM (Fijo por simplicidad)
    FOR i IN 1..50 LOOP
    ...
    -- 7. GENERAR 200 VENTAS HISTÓRICAS (Cruzadas entre clientes y catálogos)
    FOR i IN 1..200 LOOP
    ...
    -- 8. ARQUEOS HISTÓRICOS (Visible en Historial)
    FOR i IN 1..15 LOOP
    ...
    -- 9. VENTAS DE HOY (Pulso Diario Activo)
    FOR i IN 1..15 LOOP
        v_venta_id := gen_random_uuid();
